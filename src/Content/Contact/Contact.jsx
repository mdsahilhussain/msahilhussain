...
export default function Contact() {
  ...
  return (
    <>
      ...
      <div className="contact___detail--cardTwo">
        <div className="contact___detail--cardTwo___header">
          <h3>
            Start by <span>saying hi</span>
          </h3>
          <ul>
        ...
        <form className="contact___fromTwo" onSubmit={sendEmail}>
          <div className="contact___fromTwo--input-wrap">
            <input
              type="text"
              // value={name}
              name="user_name"
          ...
          <div className="contact___fromTwo--input-wrap-2">
            <textarea
              name="message"
              // value={description}
              cols="30"
            ...
            {message && (
              <p
                id="msg"
                className="contact___fromTwo--respoonseMessage"
                style={{ color: color }}
              >
                {message}
              </p>
